...
public:
  ...
  bool isSnaxWasmABI()const;
  std::string getWasmABI()const;
  bool isSnaxWasmEntry()const;
  bool isSnaxWasmImport()const;
  bool isSnaxWasmAction()const;
  std::string getSnaxWasmAction()const;
  bool isSnaxWasmNotify()const;
  std::string getSnaxWasmNotify()const;
